...
def add_loan():
    try:
        ...
        # NOVO: Provjeri ima li ovaj korisnik već posudbu te knjige koja nije vraćena
...
# Dodavanje recenzije (opcionalno: spriječi duple recenzije istog usera za istu knjigu)
@app.route('/reviews', methods=['POST'])
def add_review():
    try:
        data = request.get_json()
